...
% Configuration
imageDim = 55;
numClasses = 3;  % Number of classes (MNIST images fall into 10 classes)
filterDim = 4;    % Filter size for conv layer
...
% [images labels] = loadMNISTImages('train');
load('face.mat');
images = patches;
images = reshape(images,imageDim,imageDim,[]);
% labels = loadMNISTLabels('../common/train-labels-idx1-ubyte');
% labels(labels==0) = 10; % Remap 0 to 10
labels = [ones(20,1); ones(20,1)*2; ones(20,1)*3];
...
opttheta = minFuncSGD(@(x,y,z) cnnCost(x,y,z,numClasses,filterDim,...
                      numFilters,poolDim,lambda),theta,images,labels,options);
