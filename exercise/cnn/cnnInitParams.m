...
outDim = outDim/poolDim; % dimension of pooled image
hiddenSize = outDim^2*numFilters; % fully-connected layer units

% we'll choose weights uniformly from the interval [-r, r]
r  = sqrt(6) / sqrt(numClasses+hiddenSize+1); % optimized initialization 
